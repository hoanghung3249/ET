...
public class DropDown: UIView {
    ...
    //MARK: Constraints
    fileprivate var dropDownHeightConstraint: NSLayoutConstraint!
    fileprivate var dropDownWidthConstraint: NSLayoutConstraint!
...
extension DropDown {
    ...
    public override func updateConstraints() {
        ...
        dropDownWidthConstraint.constant = layout.width
        dropDownHeightConstraint.constant = layout.visibleHeight
    ...
    fileprivate func setupConstraints() {
        ...
        dropDownWidthConstraint = NSLayoutConstraint(
            item: tableViewContainer,
            attribute: .width,
            relatedBy: .equal,
            toItem: nil,
            ...
            multiplier: 1,
            constant: 0)
        tableViewContainer.addConstraint(dropDownWidthConstraint)
        
        dropDownHeightConstraint = NSLayoutConstraint(
            item: tableViewContainer,
            attribute: .height,
            relatedBy: .equal,
            toItem: nil,
            ...
            multiplier: 1,
            constant: 0)
        tableViewContainer.addConstraint(dropDownHeightConstraint)
        ...
        if allowsMultipleSelection {
            ...
            if multiSelectedRowIndex.contains(where: {$0 == selectedRowIndex}){
                if multiSelectedRowIndex.count == 1 {
                    ...
                    let indexRemove = multiSelectedRowIndex.firstIndex(where: {$0! == selectedRowIndex!})
...
extension DropDown {
    ...
    fileprivate func startListeningToKeyboard() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(keyboardUpdate), name: UIResponder.keyboardDidShowNotification, object: nil)
